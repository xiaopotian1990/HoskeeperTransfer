...
namespace HoskeeperTransfer
{
    ...
    /// 获取IDWork实例
    /// </summary>
    public class SingleIdWork
    {
        private static IdWorker _idWork = null;
        private static readonly object SynObject = new object();
        private SingleIdWork()
        {
        }
        /// <summary>
        /// 获取IDWork实例
        ...
        /// <returns></returns>
        public static IdWorker Instance(long workerId)
        {
            if (_idWork == null)
            {
                lock (SynObject)
